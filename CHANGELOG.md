...
- Add support for running tests in parallel [\#83](https://github.com/DEFRA/quke/pull/83) ([Cruikshanks](https://github.com/Cruikshanks))
...
- Update project dependencies [\#80](https://github.com/DEFRA/quke/pull/80) ([Cruikshanks](https://github.com/Cruikshanks))

**Fixed bugs:**

- Fix broken gem exe config [\#79](https://github.com/DEFRA/quke/pull/79) ([Cruikshanks](https://github.com/Cruikshanks))

**Merged pull requests:**

- Update spec config and structure [\#78](https://github.com/DEFRA/quke/pull/78) ([Cruikshanks](https://github.com/Cruikshanks))
- Updates badges in README [\#77](https://github.com/DEFRA/quke/pull/77) ([Cruikshanks](https://github.com/Cruikshanks))
- Update project to match latest CI conventions [\#76](https://github.com/DEFRA/quke/pull/76) ([Cruikshanks](https://github.com/Cruikshanks))
- Update CHANGELOG for 0.5.0 release [\#74](https://github.com/DEFRA/quke/pull/74) ([Cruikshanks](https://github.com/Cruikshanks))
