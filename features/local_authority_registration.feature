...
As a local authority, I want to register a location for a flood risk activity exemptions, so that I can check that my activity does not harm the environment in that area
